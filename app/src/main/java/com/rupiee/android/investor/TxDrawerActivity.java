...
import com.rupiee.android.mfi.user.RegisterUserFragment;
import com.rupiee.android.mfi.user.UserListFragment;
 ...
 * @since 09/05/16
 */
public class TxDrawerActivity extends AppCompatActivity {
    ...
    protected void setupDrawer() {
        ...
        mDrawer = (DrawerLayout) findViewById(R.id.tx_drawer);
    ...
    private void selectDrawerItem(MenuItem menuItem) {
        ...
        replaceFragment(R.id.ta_fragcontainer, mCurrentFragment);
